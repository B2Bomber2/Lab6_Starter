...
function getRecipesFromStorage() {
	...
	const inputRecipes = localStorage.getItem('recipes');
	if (inputRecipes) {
		return JSON.parse(inputRecipes);
	}
	else {
		return [];
	}
...
function initFormHandler() {
	...
	form.addEventListener('submit', function(event) {
		// prevent someone submitting an empty form
	...
	clearLocalStorage.addEventListener('click', function(event) {
		...
		// do the tree traversal thing from cse 100
